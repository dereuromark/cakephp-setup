...
<?php
	...
	echo $this->Form->input('persistent', ['type' => 'checkbox', ]);
	echo $this->Form->input('encoding');

echo $this->Form->input('enhanced_database_class', ['type' => 'checkbox', 'label' => __('Use enhanced database class (Setup plugin)')]);
